...
public class CalcAVGArray {
    ...
    // ===== Calculate average of an array method =====
    /**
     * Calculates the sum of all elements
     * in the specified {@code int} array.
     *
     * <p>
     * The result is returned as {@code long}
     * to prevent integer overflow.
     * </p>
     *
     * @param arr
     *            the {@code int} array whose elements
     *            will be summed
     *
     * @return
     ...
     * of all elements in the specified
     * {@code int} array.
     *
     * @param arr
     *            the {@code int} array whose average
     *            will be calculated
     *
     * @return
     ...
     *                                  or empty
     */
    public static double calcAverageArr(int[] arr) {
        if (arr == null || arr.length == 0) {
            throw new IllegalArgumentException("Array cannot be null or empty.");
        }

        long sum = calcSumArr(arr);
    ...
    public static void main(String[] args) {
        ...
        // === Handle processing ===
        avgArr = calcAverageArr(arr);

        // === Handle output ===
        System.out.printf("%.2f", avgArr);
