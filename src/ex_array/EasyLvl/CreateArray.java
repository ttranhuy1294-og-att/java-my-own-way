...
public class CreateArray {
    ...
    // ===== Print array methods =====
    /**
     * Prints all elements of the specified {@code int} array
     * separated by a single space.
     *
     * <p>
     * No trailing space is printed after the last element.
     * </p>
     *
     * <h2>Output Format</h2>
     *
     ...
     *
     * @param arr
     *            the {@code int} array to be printed
     *
    ...
    public static void main(String[] args) {
        ...
        final int MIN_ARRAY_EL_VALUE = -1_000_000;
        final int MAX_ARRAY_EL_VALUE = 1_000_000;
