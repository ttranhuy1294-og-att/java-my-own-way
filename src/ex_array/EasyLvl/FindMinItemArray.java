...
public class FindMinItemArray {
    ...
    // ===== Find minimum item in array method =====
    /**
     * Finds the index of the smallest element
     * in the specified {@code int} array.
     *
     * <p>
     * If multiple elements share the same minimum value,
    ...
    public static void main(String[] args) {
        ...
        // === Handle output ===
        minItemIdx = findMinIdx(arr);
        System.out.println(arr[minItemIdx]);
